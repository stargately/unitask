...
export const TopBar = (): JSX.Element => {
  ...
  const renderMenu = (): JSX.Element => (
    <>
      <StyledLink to="/" onClick={hideMobileMenu}>
        {t("topbar.home")}
      </StyledLink>
      <StyledLink to="/open/" onClick={hideMobileMenu}>
        {t("topbar.open")}
      </StyledLink>
      <StyledLink to="/closed/" onClick={hideMobileMenu}>
        {t("topbar.closed")}
      </StyledLink>
      <StyledLink to="/setup/" onClick={hideMobileMenu}>
        {t("topbar.setup")}
      </StyledLink>
    </>
  );
...
const StyledLink = styled(
  Link,
  ({ $theme, to }: { $theme?: Theme; to: string }) => {
